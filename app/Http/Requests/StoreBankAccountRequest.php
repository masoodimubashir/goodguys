...
class StoreBankAccountRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'qr_code_image' => 'required|file|mimes:jpeg,png,pdf|max:2048',
            ...
            'signiture_image' =>  'required|file|mimes:jpeg,png,pdf|max:2048',
            'company_stamp_image' => 'required|file|mimes:jpeg,png,pdf|max:2048',
