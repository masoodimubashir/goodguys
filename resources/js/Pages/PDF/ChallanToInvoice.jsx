...
const ChallanToInvoice = ({ company_profile, data, client, bankAccount }) => {
  ...
  const formattedDate = data?.created_at ? new Date(data.created_at).toLocaleDateString() : currentDate;
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <ClientInfo client={client} challan={{ ...data, date: formattedDate, prepared_by: company_profile?.company_name }} serviceCharge={serviceCharge} hasPrices={hasPrices} />
