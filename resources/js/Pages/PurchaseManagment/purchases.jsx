...
import {
    Edit, Trash2, Plus, Save, ChevronDown, ChevronRight, CreditCard, DollarSign,
    PieChart, Wallet, IndianRupee, Phone, Mail, MapPin, FileText, Building2,
    User2, Package, RefreshCw, ClipboardList, HandCoins, Undo2, AlertTriangle,
    TrendingUp, TrendingDown, Calendar, Clock, Target, Activity, BarChart3,
    CheckCircle, XCircle, AlertCircle, Eye, EyeOff, Filter, Download,
    ArrowUpRight, ArrowDownRight, Percent, Calculator, Receipt, Timer,
    Zap, Award, ShoppingCart, Banknote, RotateCcw
} from 'lucide-react';
...
const Purchases = ({ vendor }) => {
    ...
    const handlePurchaseChange = (id, field, value) => {
        console.log(`Updating purchase ${id}: ${field} = ${value}`);
        triggerCardAnimation(`purchase-${id}`);
    };

    const savePurchase = (purchase) => {
        triggerCardAnimation(`purchase-${purchase.id || 'new'}`);
        if (purchase.id) {
    ...
    const deletePurchase = (id) => {
        if (window.confirm('Delete this purchase and all its allocations?')) {
            triggerCardAnimation(`purchase-${id}`);
    ...
    const getStatusIcon = (remaining) => {
        if (remaining < 0) return <XCircle size={16} />;
        if (remaining === 0) return <CheckCircle size={16} />;
                                    ...
                                    <Card.Body className="p-3">
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <div className="bg-white bg-opacity-20 p-3 rounded-circle text-black">
                                                <Receipt size={28} className="icon-bounce" />
                                            </div>
                                        </div>
                                    </Card.Body>
                                </Card>
                                ...
                                <Card className={`border-0 shadow-sm h-100 card-hover gradient-success text-white ${animatingCards.has('total-paid') ? 'pulse-animation' : ''}`}>
                                    <Card.Body className="p-3">
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <div className="bg-white bg-opacity-20 p-3 rounded-circle text-black">
                                                <Banknote size={28} className="icon-bounce" />
                                            </div>
                                        </div>
                                    </Card.Body>
                                </Card>
                                ...
                                <Card className={`border-0 shadow-sm h-100 card-hover gradient-warning text-white ${animatingCards.has('total-returns') ? 'pulse-animation' : ''}`}>
                                    <Card.Body className="p-3">
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <div className="bg-white bg-opacity-20 p-3 rounded-circle text-black">
                                                <Package size={28} className="icon-bounce" />
                                            </div>
                                        </div>
                                    </Card.Body>
                                </Card>
                                ...
                                <Card className={`border-0 shadow-sm h-100 card-hover gradient-info text-white ${animatingCards.has('remaining') ? 'pulse-animation' : ''}`}>
                                    <Card.Body className="p-3">
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <div className="bg-white bg-opacity-20 p-3 rounded-circle text-black">
                                                <Wallet size={28} className="icon-bounce" />
                                            </div>
                                        </div>
                                    </Card.Body>
                                </Card>
                                        ...
                                        <div className="space-y-3">
                                            <div>
                                                <div className="d-flex justify-content-between align-items-center mb-1">
                                                    <span className="text-muted">Payment Efficiency</span>
                                                    <span className="fw-bold">{analytics.paymentEfficiency.toFixed(1)}%</span>
                                                </div>
                                                <ProgressBar
                                                    now={analytics.paymentEfficiency}
                                                    variant="success"
                                                    style={{ height: '6px' }}
                                                />
                                            </div>
                                            <div>
                                                <div className="d-flex justify-content-between align-items-center mb-1">
                                                    ...
                                                    <span className="fw-bold">{analytics.returnRate.toFixed(1)}%</span>
                                                </div>
                                                <ProgressBar
                                                    now={analytics.returnRate}
                                                    variant="warning"
                                                    style={{ height: '6px' }}
                                                />
                                            </div>
                                            <div>
                                                <div className="d-flex justify-content-between align-items-center mb-1">
                                                    ...
                                                    <span className="fw-bold">
                                                        {purchases.length > 0 ? ((analytics.completedPurchases / purchases.length) * 100).toFixed(1) : 0}%
                                                    </span>
                                                </div>
                                                <ProgressBar
                                                    now={purchases.length > 0 ? (analytics.completedPurchases / purchases.length) * 100 : 0}
                                                    variant="info"
                                                    style={{ height: '6px' }}
                                                />
                                            </div>
                                ...
                                {purchases.map((purchase, index) => {
                                    ...
                                    return (
                                        <React.Fragment key={purchase.id}>
                                            <tr className={`align-middle table-row-hover ${animatingCards.has(`purchase-${purchase.id}`) ? 'bounce-in' : ''}`}>
                                                <td>
                                                    <Button
                                                        variant="link"
                                                    ...
                                                    >
                                                        {isExpanded
                                                            ? <ChevronDown size={16} className="icon-bounce" />
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        <Form.Control
                                                            size="sm"
                                                            value={purchase.list_name}
                                                            onChange={e => handlePurchaseChange(
                                                                purchase.id,
                                                                'list_name',
                                                                e.target.value
                                                            )}
                                                ...
                                                <td>
                                                    {isEditing ? (
                                                        ...
                                                        <div className="d-flex gap-1">
                                                            <CustomTooltip text="Edit Purchase">
                                                                <Button
                                                                    variant="link"
                                                            ...
                                                            <CustomTooltip text="Delete Purchase">
                                                                <Button
                                                                    variant="link"
                                                                    ...
                                                                    <Table hover responsive className="mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            {(purchase.purchase_managments || []).map((allocation, allocIndex) => {
                                                                                ...
                                                                                return (
                                                                                    <tr key={allocation.id} className={`table-row-hover ${animatingCards.has(`allocation-${allocation.id}`) ? 'bounce-in' : ''}`}>
                                                                                        <td>
                                                                                            {isEditingAllocation ? (
                                                                                                <Form.Control
                                                                                                    size="sm"
                                                                    ...
                                                                    <Table hover responsive className="mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            {returns.map((returnItem, returnIndex) => {
                                                                                ...
                                                                                return (
                                                                                    <tr key={returnItem.id} className={`table-row-hover ${animatingCards.has(`return-${returnItem.id}`) ? 'bounce-in' : ''}`}>
                                                                                        <td>
                                                                                            {isEditingReturn ? (
                                                                                                <Form.Control
                                                                                                    size="sm"
                                    ...
                                    <tr>
                                        <td colSpan={7} className="text-center py-5">
                                            <div className="text-muted">
                                                ...
                                                <h5 className="mb-2">No Purchase Orders Found</h5>
